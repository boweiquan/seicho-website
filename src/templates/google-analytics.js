...
const GoogleAnalytics = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/google-analytics' : `/category/google-analytics/${currentPage - 1}`
    const nextPage = `/category/google-analytics/${currentPage + 1}`
...
export const pageQuery = graphql `
    query GoogleAnalyticsQuery ($skip: Int!, $limit: Int!) {
        allContentfulBlog(
