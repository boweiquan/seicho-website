...
const Podcast = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/podcast' : `/category/podcast/${currentPage - 1}`
    const nextPage = `/category/podcast/${currentPage + 1}`
...
export const pageQuery = graphql `
    query PodcastQuery ($skip: Int!, $limit: Int!) {
        allContentfulBlog(
